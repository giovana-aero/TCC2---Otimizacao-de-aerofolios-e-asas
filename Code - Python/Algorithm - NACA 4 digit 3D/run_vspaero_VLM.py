...
def run_vspaero_VLM(pop,dat):
    ...
    for P in range(dat.cases):
        ...
        # print('impressão terminada')
        
        # Executar a simulação
        # print('começar simulação')
        os.system('vspaero -omp 4 ' + name)
        
        # # apagar executável
        # os.remove('vspaero.exe')
        # # copiar um novo
        # d1 = 'C:\\Users\Guga Weffort\Documents\Coisas radicais de programacao\python\TCC2\CODE - PYTHON\\vspaero.exe'
        # d2 = 'C:\\Users\Guga Weffort\Documents\Coisas radicais de programacao\python\TCC2\CODE - PYTHON\Algorithm - NACA 4 digit 3D\\vspaero.exe'
        ...
        # print('ler resultados')
        results = np.genfromtxt(name + '.polar',usecols = (4,7,9,15))
        ...
        aero[P][:] = [results[0][0],results[0][1],results[0][2],results[0][3]]
        # del results,fid
        return aero
