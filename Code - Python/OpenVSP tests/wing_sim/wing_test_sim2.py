...
# Descrição desta versão: o código gera uma asa trapezoidal simples com 
# perfis naca 4 dígitos. É possível alterar as dimensões da asa e escolher
# os aerofólios. Ao final é feita uma simulação no prompt de comando e os 
# resultados são lidos
...
# // ===== Criar uma asa trapezoidal simples com perfis NACA 4 dígitos ====//
