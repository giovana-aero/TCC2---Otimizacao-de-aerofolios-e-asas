...
dat.b_ext = [-0.5,0.5,1]; % Envergadura completa [m] (limite inferior, limite superior, valor mínimo possível)
...
dat.B_ext2_r = [dat.or_v_ex_r(end-1) + dat.or_v_in_r(end-1),5]; % O primeiro número é a separação mínima do extradorso, o segundo é o limite superior
...
dat.B_ext2_m = [dat.or_v_ex_m(end-1) + dat.or_v_in_m(end-1),5]; % O primeiro número é a separação mínima do extradorso, o segundo é o limite superior
...
dat.B_ext2_t = [dat.or_v_ex_t(end-1) + dat.or_v_in_t(end-1),5]; % O primeiro número é a separação mínima do extradorso, o segundo é o limite superior
dat.tw_t_ext = [0,-5];
...
dat.coeff_op = ['o','!','^','o';       % Uma linha para cada condição de voo
                '!','!','!','!';
                '!','!','!','!'];
dat.coeff_val = [0.5373,7e-3,90,-0.1302;
                 0.5,0,0,-0.08;
                 0,0,0,-0.08];
dat.coeff_F = [1,1,1,1;
               1,1,1,1;
