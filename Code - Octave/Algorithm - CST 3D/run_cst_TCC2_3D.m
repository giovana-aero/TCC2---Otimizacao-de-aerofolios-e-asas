function coo = run_cst_TCC2_3D(v_ex,v_in,dat,v_N,op)
    
% Modificação: retirada do fator de escala
% Modificação da versão 3D: especificação de N1 e N2 separadamente do struct dat
...
if nargin == 4 % Ignorar a impressão de coordenadas se op sequer estiver no input da função
    op = 0;
end
